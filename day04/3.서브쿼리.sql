...
-- 가상의 테이블을 만들어서 마치 실제 테이블인 것 처럼 사용가능
...
-- 복잡한 서브쿼리도 가능! 26/03/04 기준으로 참조만 해보기
...
-- 상호연관 서브쿼리 - 알고만 있기. 실무에서 확인
-- 메인쿼리 데이터를 서브쿼리 사용, 그 결과를 다시 메인쿼리에 반영
